execute store result score #Star_amout Temporary run data get entity @s equipment.legs.components."minecraft:custom_data".Star
execute store result score #Master_Star_amout Temporary run data get entity @s equipment.legs.components."minecraft:custom_data".MStar
