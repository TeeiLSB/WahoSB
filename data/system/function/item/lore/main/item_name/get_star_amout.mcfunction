execute store result score #Star_amout Temporary run data get block 0 0 0 Items[0].components."minecraft:custom_data".Star
execute store result score #Master_Star_amout Temporary run data get block 0 0 0 Items[0].components."minecraft:custom_data".MStar
