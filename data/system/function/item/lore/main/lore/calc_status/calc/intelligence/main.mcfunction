...
execute if data entity @s SelectedItem.components."minecraft:custom_data".ReforgeStatus.Int store result storage temp: temp_setting.Reforge int 1 run data get entity @s SelectedItem.components."minecraft:custom_data".ReforgeStatus.Int

## Gemstone
 execute store result score #Gem_1 Temporary run data get entity @s SelectedItem.components."minecraft:custom_data".GemstoneS_1.Int
 execute store result score #Gem_2 Temporary run data get entity @s SelectedItem.components."minecraft:custom_data".GemstoneS_2.Int
...
## 最終計算
 execute store result score #Base Temporary run data get entity @s SelectedItem.components."minecraft:custom_data".Stats.Intelligence
 execute store result score #Reforge Temporary run data get entity @s SelectedItem.components."minecraft:custom_data".ReforgeStatus.Int
...
# reforgeがない場合
 execute unless data entity @s SelectedItem.components."minecraft:custom_data".ReforgeStatus.Int run \
...
# gemがない場合
 execute unless data entity @s SelectedItem.components."minecraft:custom_data".GemstoneS_1.Int unless data entity @s SelectedItem.components."minecraft:custom_data".GemstoneS_2.Int run data modify storage temp: temp_lore.Gemstone set value ""
...
scoreboard players operation @s[tag=!InDungeon] MainHand.Int = #Base Temporary
scoreboard players operation @s[tag=InDungeon] MainHand.Int = #ForDungeon Temporary
