...
# 足す
 ...
 execute unless data entity @s SelectedItem.components."minecraft:custom_data".Armor run scoreboard players operation #Base Temporary += #PotatoBook.Amount Temporary
