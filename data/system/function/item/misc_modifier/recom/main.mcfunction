...
scoreboard players operation #Rarity Temporary += #1 Constant
scoreboard players operation #Rarity Temporary < #8 Constant

execute store result storage temp: temp_item.value int 1 run scoreboard players get #Rarity Temporary
