particle firework
tag @s add Beamer
execute positioned ~-0.125 ~-0.125 ~-0.125 as @e[dx=0,type=!player,type=!item,limit=1,sort=nearest,type=!arrow,tag=!Invulnerable] positioned ~-0.75 ~-0.75 ~-0.75 if entity @s[dx=0] run function system:dungeon/class/mage/mage_beam/hit_entity
tag @s remove Beamer
