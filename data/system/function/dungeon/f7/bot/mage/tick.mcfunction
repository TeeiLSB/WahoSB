execute if score @s Bot.ActionProcess matches 0 if score @s Bot.IsInAction matches 0 positioned 82 221 46 run function system:bot/main/run
...
execute if score @s Bot.ActionProcess matches 7 if score @s Bot.IsInAction matches 0 positioned 81 238 50 run function system:bot/main/run
...
execute if score @s Bot.ActionProcess matches 10 if score @s Bot.IsInAction matches 0 positioned 84 238 49 run function system:bot/main/run
...
execute if score @s Bot.ActionProcess matches 12 if score @s Bot.IsInAction matches 0 positioned 94 224 41 run function system:bot/main/run


# wait for maxor enrage

execute if score $MaxorEnraged F7.Gimmick.Status matches 1 if score $MaxorPhase F7.Gimmick.Status matches 1 if score @s Bot.ActionProcess matches 13 if score @s Bot.IsInAction matches 0 positioned 91 224 44 run function system:bot/main/run


# second crystal
execute if score @s Bot.ActionProcess matches 14 if score @s Bot.IsInAction matches 0 run function system:bot/actions/generic/wait/run {"tick":"20"}
execute if score @s Bot.ActionProcess matches 15 if score @s Bot.IsInAction matches 0 positioned 82 221 46 run function system:bot/main/run
...
execute if score @s Bot.ActionProcess matches 22 if score @s Bot.IsInAction matches 0 positioned 81 238 50 run function system:bot/main/run
...
execute if score @s Bot.ActionProcess matches 24 if score @s Bot.IsInAction matches 0 run function system:bot/actions/f7/pickup_crystal
execute if score @s Bot.ActionProcess matches 25 if score @s Bot.IsInAction matches 0 positioned 84 238 49 run function system:bot/main/run
...
execute if score @s Bot.ActionProcess matches 27 if score @s Bot.IsInAction matches 0 positioned 94 224 41 run function system:bot/main/run

# boots
execute if score @s Bot.ActionProcess matches 28 if score @s Bot.IsInAction matches 0 run function system:bot/actions/inventory/armor/storm_boots