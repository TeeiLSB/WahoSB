...
execute if score $LeftCrystal F7.Gimmick.Status matches 1 if score @s Bot.ActionProcess matches 13 if score @s Bot.IsInAction matches 0 positioned 91 224 44 run function system:bot/main/run
