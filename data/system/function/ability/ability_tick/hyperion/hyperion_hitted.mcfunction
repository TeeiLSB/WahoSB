...
execute store result storage lib: dmg.value int 1 run scoreboard players get @n[tag=This] Status.MagicDamage
execute if entity @s[tag=!Invulnerable] run loot spawn ~ ~ ~ loot system:damage/damage_indicator_magic
