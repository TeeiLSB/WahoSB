...
execute if score @s CD.default matches 0 at @s anchored eyes positioned ^ ^ ^1.75 rotated as @s rotated ~4.5 ~1.75 summon arrow run function system:ability/bow/terminator/arrow/init
execute if score @s CD.default matches 0 at @s anchored eyes positioned ^ ^ ^1.75 rotated as @s rotated ~-4.5 ~1.75 summon arrow run function system:ability/bow/terminator/arrow/init
